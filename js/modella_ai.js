...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initModellaAIForm();
    initFloatingFaces();
    initGalleryLightbox(); // ← AGGIUNGI QUESTA RIGA
    
    console.log('Modella AI page loaded successfully!');
});

/// ========== Face Style Interaction - VERSIONE SEMPLIFICATA ==========
function initFaceStyleInteraction() {
    // Non serve più nulla, usiamo onclick inline
    console.log('Face style interaction semplificata attivata');
}

// Funzione per aprire lightbox - VERSIONE CORRETTA
function openLightbox(imageSrc) {
    const lightbox = document.getElementById('lightbox');
    const lightboxImage = document.getElementById('lightbox-image');
    
    if (lightbox && lightboxImage) {
        // Reset immagine precedente
        lightboxImage.src = '';
        ...
        // Carica nuova immagine con animazione
        lightboxImage.onload = function() {
            this.style.opacity = '1';
        };
        
        // Imposta nuova src (questo triggera il caricamento)
