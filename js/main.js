    ...
    const observer = new IntersectionObserver(function(entries) {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Una volta animato, non osservare più
...
function initAIMagicCarousel() {
    ...
    magicBtn.addEventListener('click', function() {
        ...
        setTimeout(() => {
            ...
            const style1 = slot1.querySelector('.photo-style');
            const style2 = slot2.querySelector('.photo-style');
            
            if (img1 && img2 && style1 && style2) {
                ...
                preloadImg1.onload = () => {
                    ...
                    img1.alt = `Risultato AI ${newImages.slot1.style}`;
                    style1.textContent = newImages.slot1.style;
                };
                
                preloadImg2.onload = () => {
                    img2.src = newImages.slot2.src;
                    img2.alt = `Risultato AI ${newImages.slot2.style}`;
                    style2.textContent = newImages.slot2.style;
                };
